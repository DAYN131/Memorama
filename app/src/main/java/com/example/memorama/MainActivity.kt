...
class MainActivity : AppCompatActivity() {
    ...
    private fun enlazarGUI() {
        ...
        usopp = R.drawable.usopp
        nami = R.drawable.nami
        chopper = R.drawable.chopper
    ...
    private fun verificar(imagen: View) {
        ...
        if(imagenesArray[tag] == 11){
            iv.setImageResource(luffy)
        } else if(imagenesArray[tag] == 12){
            iv.setImageResource(zoro)
        } else if (imagenesArray[tag] == 13){
            iv.setImageResource(sanji)
        } else if (imagenesArray[tag] == 14){
            iv.setImageResource(usopp)
        } else if(imagenesArray[tag] == 15){
            iv.setImageResource(nami)
        }  else if(imagenesArray[tag] == 16) {
            iv.setImageResource(chopper)
    ...
    private fun sonImagenesIguales() {
        ...
        if(imagen1.drawable.constantState == imagen2.drawable.constantState ){
            ...
            sonido("no")
            imagen1.setImageResource(R.drawable.pregunta)
            imagen2.setImageResource(R.drawable.pregunta)
